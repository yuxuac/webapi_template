...
using WebApiTemplate.HealthChecks;
using WebApiTemplate.Models.Authentication;
...
namespace WebApiTemplate
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHealthChecks().AddCheck<HealthCheck>("mainHealth");
            ...
            services.AddSingleton<IStudentsBO, StudentsBO>();
